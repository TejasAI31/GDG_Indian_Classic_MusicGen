        ...
        <div className="py-12 bg-gray-900 ">
            <div>
                <div className="text-center">
                    ...
                    <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-white sm:text-4xl cursor-pointer">Dive into the world of Indian Classical Music</p>
                </div>
            </div>
            <div className="mt-11">
            ...
            <div className="mt-20 text-center">
                <span
                    className="px-4 py-2 border-neutral-600 bg-white hover:bg-gray-300 text-neutral-800 transition-duraation-200 text-center cursor-pointer"
                >
                    View all courses
                </span>
            </div>
